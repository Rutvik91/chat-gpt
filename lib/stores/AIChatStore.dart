...
*/
  ...
  Map<String, dynamic> _createChat(String aiType, String chatId) {
  ...
  Map<String, dynamic> getChatById(String chatType, String chatId) {
    Map<String, dynamic>? chat = chatList.firstWhere(
      (v) => v['id'] == chatId,
      orElse: () => null,
    );
  ...
  Future<Map> pushMessage(
      Map<String, dynamic> chat, Map<String, dynamic> message) async {

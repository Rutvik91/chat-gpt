...
class ChatGPT {
  ...
  static List categories = [
    {
      ...
      "tips": [
        ...
        "Write a song about",
        "Write a Detailed recipe for",
        "Write a workout routine for",
      ]
    },
    {
      "name": 'Social',
      ...
      "tips": [
        "Write a tweet",
        "Find me a captions for a ",
        "Birthday card message",
        "Congratulation message for",
      ]
    },
    {
      "name": 'Email',
    ...
    },
    {
      ...
      "tips": [
        ...
        "How to talk with customers about",
        "Tell me about",
      ]
    },
    {
      ...
      "tips": [
        ...
        "What is the best tutorial for flutter",
        "What is state management in flutter explain",
      ]
    },
    {
      "name": 'Node js',
      ...
      "tips": [
        "What is node?",
        "How to learn node",
        "What is the best tutorial for node",
        "explain authentication in node with example",
        "login register flow with code",
      ]
    },
  ];
  ...
  static Future<void> initChatGPT() async {
    ...
    var result = await FirebaseFirestore.instance
        ...
        .doc('chatGpt')
        .get();
    var apiKey = cacheKey != '' ? cacheKey : result.get('apiKey');
    OpenAI.apiKey = apiKey;
    if (apiKey != result.get('apiKey')) {
      OpenAI.baseUrl =

...
class Config {
  static const Color primary = Color(0xff0d1119);
  static const Color primary2 = Color(0xff89d5d2);
  static const Color background = Color(0xff232023);
  ...
  static String appName = 'Chat Buddy';
